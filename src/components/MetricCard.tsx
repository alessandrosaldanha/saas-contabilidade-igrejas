...
export default function MetricCard({ label, value, delta, deltaTone = "neutral", valueColor }: MetricCardProps) {
  return (
    <div className="min-w-0 overflow-hidden bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 rounded-lg p-5">
      <div className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">{label}</div>
